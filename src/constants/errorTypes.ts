...
export const E_ERROR = {
  CHANGE_INSUFFICIENT_TO_PAY_DEBT_AND_MAKE_DEPOSIT: { message: 'Jumlah kembalian tidak cukup untuk membayar hutang dan menambahkan deposit', status: HTTP_CODE.BAD_REQUEST },
  CANT_PAY_DEBT_FOR_UNREGISERED_CUSTOMER          : { message: 'Pelanggan tidak terdaftar tidak dapat melakukan pembayaran hutang', status: HTTP_CODE.BAD_REQUEST },
  CANT_MAKE_DEBT_FOR_UNREGISTERED_CUSTOMER        : { message: 'Pelanggan yang tidak terdaftar tidak dapat melakukan transaksi hutang.', status: HTTP_CODE.BAD_REQUEST },
  ...
  INSUFFICIENT_STOCK_GDG                          : { message: 'Stock Gudang tidak cukup', status: HTTP_CODE.NOT_FOUND },
  ...
  CASHFLOW_NOT_FOUND                              : { message: 'Cashflow not found', status: HTTP_CODE.BAD_REQUEST },
  STATISTIC_NOT_FOUND                             : { message: 'Statistic not found', status: HTTP_CODE.BAD_REQUEST }
} as const
