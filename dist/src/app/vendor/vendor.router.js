...
let VendorController = class VendorController extends tsoa_1.Controller {
    getAllVendor() {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, vendor_service_1.getAllVendorService)();
        });
    }
    findVendor(query) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, vendor_service_1.findVendorService)(query);
        });
    }
    addVendor(body) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, vendor_service_1.addVendorService)(body);
        });
    }
    updateVendor(id, body) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, vendor_service_1.updateVendorService)(id, body);
        });
    }
    deleteVendor(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, vendor_service_1.deleteVendorService)(id);
        });
    }
};
__decorate([
