...
let employeeController = class employeeController extends tsoa_1.Controller {
    getAllEmployee() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield (0, employee_service_1.getAllEmployeeService)();
            }
            catch (error) {
                return error;
            }
    ...
    createEmployee(body) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return response_1.default.success({ data: createdEmployee });
            }
            catch (error) {
                return error;
            }
    ...
    updateEmployee(id, body) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return response_1.default.success({ data: updatedEmployee });
            }
            catch (error) {
                return error;
            }
    ...
    searchEmployee(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield (0, employee_service_1.searchEmployeeService)(query);
            }
            catch (error) {
                return error;
            }
    ...
    deleteEmployee(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return response_1.default.success({ data: deletedEmployee });
            }
            catch (error) {
                return error;
            }
    ...
    changeEmployeeRole(id, { role_id }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return response_1.default.success({ data: patchedEmployee });
            }
            catch (error) {
                return error;
            }
