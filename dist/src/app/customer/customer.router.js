...
let CustomerController = class CustomerController extends tsoa_1.Controller {
    ...
    getDeposit(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const customer = yield (0, customer_service_1.getCustomerDepositService)(+id);
                return response_1.default.success({ data: customer });
            }
            catch (error) {
                return error;
    ...
    addDeposit(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const customer = yield (0, customer_service_1.addDepositService)(payload);
                return response_1.default.success({ data: customer });
            }
            catch (error) {
                return error;
    ...
    payDebt(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const customer = yield (0, customer_service_1.payDebtService)(payload);
                return response_1.default.success({ data: customer });
            }
            catch (error) {
                return error;
    ...
    getDebt(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const customerDebt = yield (0, customer_service_1.getCustomerDebtService)(+id);
                return response_1.default.success({ data: customerDebt });
            }
            catch (error) {
                return error;
            }
    ...
    createCustomer(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const customer = yield (0, customer_service_1.createCustomerService)(payload);
                return response_1.default.success({ data: customer });
            }
            catch (error) {
                return error;
...
__decorate([
    (0, tsoa_1.Get)('/deposit/{id}/'),
    (0, tsoa_1.Security)('api_key', ['read:customer']),
    __param(0, (0, tsoa_1.Path)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CustomerController.prototype, "getDeposit", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CustomerController.prototype, "addDeposit", null);
__decorate([
    (0, tsoa_1.Post)('/debt/pay'),
    (0, tsoa_1.Security)('api_key', ['create:customer']),
    __param(0, (0, tsoa_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], CustomerController.prototype, "payDebt", null);
__decorate([
    (0, tsoa_1.Get)('/debt/{id}/'),
    (0, tsoa_1.Security)('api_key', ['read:customer']),
    __param(0, (0, tsoa_1.Path)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CustomerController.prototype, "getDebt", null);
__decorate([
    (0, tsoa_1.Post)('/'),
    (0, tsoa_1.Security)('api_key', ['create:customer']),
    __param(0, (0, tsoa_1.Body)()),
