...
let StockController = class StockController extends tsoa_1.Controller {
    getAllStock() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, stock_service_1.getAllStocksService)();
        });
    }
    getStockToko() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const stocks = yield (0, stock_service_1.getStockTokoService)();
    ...
    updateStock(id, body) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, stock_service_1.updateStockService)(body, id);
        });
    }
    deleteStock(id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    findStock(query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, stock_service_1.findStockService)(query);
        });
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], StockController.prototype, "getStockToko", null);
__decorate([
    (0, tsoa_1.Put)('/{id}'),
