...
let UserPermissionController = class UserPermissionController extends tsoa_1.Controller {
    getAllUser() {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, user_service_1.getAllUserService)();
        });
    }
    createUser(body) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, user_service_1.createUserService)({ email: body.email, roles: body.roles });
        });
    }
    updateUser(id, body) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, user_service_1.updateUserService)({ id: Number(id), email: body.email, roles: body.roles });
        });
    }
    deleteUser(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, user_service_1.deleteUserService)({ id: Number(id) });
        });
    }
};
__decorate([
